...
class Value:
    def __init__(self, data, _children=(), _op="", label=""):
        self.data = data # numerical val
        self.grad = 0.0 # gradient (start = 0.0 no change in var)
        self._backward = lambda : None
        self._prev = set(_children) # nodes
        self._op = _op # operation generated by the node
        self.label = label
    ...
    def __rtruediv__(self, other):  # quando fai: numero / Value
    ...
    def __neg__(self):
        ...
        return out
    def __sub__(self, other): # sottrazione
        return self + (-other)

    def __radd__(self, other): # support for op as 3 + Value(...)
        return self + other
